...
@Component({
  selector: 'app-smokingcessation',
  templateUrl: './smokingcessation.component.html',
  styleUrls: ['./smokingcessation.component.scss']
})
export class SmokingCessationComponent implements OnInit {
  ...
  ngAfterContentInit(){
    ...
    timedSegment.topic = "Resource SmokingCessation";
