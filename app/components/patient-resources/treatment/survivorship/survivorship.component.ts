...
@Component({
  selector: 'app-survivorship',
  templateUrl: './survivorship.component.html',
  styleUrls: ['./survivorship.component.scss']
})
export class SurvivorshipComponent implements OnInit {

  isFav: boolean = false;
  label: string = "Servicios de supervivencia del cáncer";
  ...
  ngAfterContentInit(){
    ...
    timedSegment.topic = "Resource Survivorship";
