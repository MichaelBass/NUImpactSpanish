...
@Component({
  selector: 'app-balanced-diet',
  templateUrl: './balanced-diet.component.html',
  styleUrls: ['./balanced-diet.component.scss']
})
export class BalancedDietComponent implements OnInit {

  isFav: boolean = false;
  label: string = "Maintaining a Balanced Diet";
  ...
  ngAfterContentInit(){
    ...
    timedSegment.topic = "Resource Balanced Diet";
