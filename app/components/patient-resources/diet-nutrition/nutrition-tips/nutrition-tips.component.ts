...
@Component({
  selector: 'app-nutrition-tips',
  templateUrl: './nutrition-tips.component.html',
  styleUrls: ['./nutrition-tips.component.scss']
})
export class NutritionTipsComponent implements OnInit {

  isFav: boolean = false;
  label: string = "Consejos nutricionales";
  ...
  ngAfterContentInit(){
    ...
    timedSegment.topic = "Resource Nutrition Tips";
