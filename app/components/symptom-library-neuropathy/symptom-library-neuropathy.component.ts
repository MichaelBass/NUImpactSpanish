...
@Component({
  selector: 'app-symptom-library-neuropathy',
  templateUrl: './symptom-library-neuropathy.component.html',
  styleUrls: ['./symptom-library-neuropathy.component.scss']
})
export class SymptomLibraryNeuropathyComponent implements OnInit {
	isWarn: boolean = true;
	...
	ngOnInit() {
	  ...
	  ngAfterContentInit(){
	    ...
	    timedSegment.topic = "SymptomLibrary Neuropathy";
